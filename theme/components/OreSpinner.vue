<template>
  <span
    ...
    aria-label="Loading"
  >
    <svg viewBox="0 0 278 8" aria-hidden="true" :style="{ color: colorProp || undefined }">
      <path fill="currentColor" fill-rule="evenodd" :d="SPINNER_PATH" />
    </svg>
  </span>
</template>
...
.oreui-spinner svg {
  ...
  max-width: none;
  height: 100%;
  animation: oreui-spinner-sweep 800ms steps(15, jump-end) infinite;
}
